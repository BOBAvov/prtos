...
type LoginRequest struct {
	...
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`
	AppId         int32                  `protobuf:"varint,32,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type IsAdminResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	IsAmin        bool                   `protobuf:"varint,1,opt,name=is_amin,json=isAmin,proto3" json:"is_amin,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IsAdminResponse) GetIsAmin() bool {
	if x != nil {
		return x.IsAmin
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x06app_id\x18  \x01(\x05R\x05appId\"%\n" +
	"\rLoginResponse\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\")\n" +
	"\x0eIsAdminRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\"*\n" +
	"\x0fIsAdminResponse\x12\x17\n" +
	"\ais_amin\x18\x01 \x01(\bR\x06isAmin2\xab\x01\n" +
	"\x04Auth\x129\n" +
